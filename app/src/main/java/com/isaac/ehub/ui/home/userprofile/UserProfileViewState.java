...
public class UserProfileViewState {
    ...
    public static UserProfileViewState validating(boolean isAvatarValid, boolean isNameValid, boolean isLastNameValid, boolean isBirthDateValid, boolean isCountryValid){
